...
from mindspore.dataset.vision import Normalize, RandomResizedCrop, ToTensor, Resize, \
    CenterCrop, Grayscale, Pad, Crop
from mindspore.dataset.vision import RandomColorAdjust as ColorJitter
...
from cambrian.open_clip.utils import to_2tuple
...
def center_crop_or_pad(img, output_size: List[int], fill=0):
    ...
    if crop_width > image_width or crop_height > image_height:
        ...
        img = Pad(padding_ltrb, fill_value=fill)(img)
        _, image_height, image_width = img.shape
    ...
    return Crop(coordinates=(crop_top, crop_left), size=(crop_height, crop_width))(img)
