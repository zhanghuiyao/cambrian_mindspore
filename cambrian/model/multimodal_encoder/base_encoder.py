...
class BaseVisionTower(nn.Cell):
    ...
    def dtype(self):
        ...
        if hasattr(self.vision_tower, 'dtype'):
            ...
            params = list(self.vision_tower.get_parameters())
            return params[0].dtype if len(params) > 0 else ms.float32  # Default to torch.float32 if no parameters
