...
from cambrian.timm.models._registry import split_model_name_tag, is_model, model_entrypoint
from cambrian.timm.models._helpers import load_checkpoint
from cambrian.timm.layers.config import set_layer_config
...
def create_model(
    ...
    if checkpoint_path:
        param_not_load, ckpt_not_load = load_checkpoint(model, checkpoint_path)
        print(f"param_not_load num: {len(param_not_load)}, ckpt_not_load num: {len(ckpt_not_load)}")
