...
from transformers.utils import logging, GENERATION_CONFIG_NAME
from transformers.utils.hub import PushToHubMixin, is_remote_url, download_url, cached_file, extract_commit_hash
...
class GenerationConfig(PushToHubMixin):
    ...
    def validate(self, is_init=False):
        ...
        if self.cache_config is not None:
            cache_class = NEEDS_CACHE_CONFIG.get(self.cache_implementation, None)
